document.addEventListener('DOMContentLoaded', function() {
    ...
    const translations = {
        pt: {
            ...
            nova_empresa_descricao: "A Brightdome é uma empresa de consultoria nos Estados Unidos.",
            nova_empresa_detalhes: "Trabalho com migrações de SEO técnico, análise de SEO e Otimização de Taxa de Conversão (CRO), garantindo a continuidade dos dados e o monitoramento de desempenho durante transições de sites.\nProjeto e implemento arquiteturas personalizadas de Google Tagging usando camadas de dados (data layers) sob demanda para analisar o comportamento do usuário antes e depois de migrações.\nUtilizo BigQuery e Python para análise de dados e automação, além de Looker Studio e Power BI para entregar insights acionáveis.\nTambém trabalho com Plataformas de Dados de Clientes (CDPs), como a Segment, para unificar dados de usuários de diversas fontes.\nA função envolve colaboração direta com equipes globais na Austrália, Nova Zelândia, Estados Unidos, Holanda, Espanha e outras regiões.",
            hurb_descricao: "A Hurb era uma empresa de turismo; seus principais produtos eram diárias de hotéis e pacotes de viagem.",
            hurb_detalhes: "Trabalhei principalmente com Growth e Otimização de Taxa de Conversão (CRO), analisando dados com Python e BigQuery.\nDurante uma de minhas análises no Google Analytics (GA4), identifiquei uma demanda de mercado não atendida. Para validar esse insight, projetei e executei um teste A/B usando o Kameleoon para entender a resposta dos clientes. O projeto alcançou um ROI superior a 4000%, representando 20% da receita total dos produtos envolvidos.\nAlém disso, entreguei outros projetos de alto valor, incluindo uma análise aprofundada de dados hoteleiros, na qual construí uma apresentação altamente intuitiva adotada em toda a empresa e utilizada como base para grandes decisões estratégicas.",
            hurb_fim: "O cargo foi encerrado devido à falência da empresa, resultando em uma demissão em massa em toda a companhia.",
            ...
            frete_detalhes: "Trabalhei no departamento comercial, com foco nos clientes estratégicos da empresa (key accounts). Utilizei o Snowflake para criar consultas SQL que alimentavam os relatórios que desenvolvi no Tableau. Tínhamos um forte foco na qualidade dos dados, e desenvolvi uma forma para que os usuários monitorassem essa qualidade em tempo real, diretamente nos relatórios que estavam analisando. Também padronizei o design visual de todos os relatórios do Tableau, aplicando princípios de design UI/UX.\nFui responsável pelo projeto de Self-Service Analytics da empresa, que visava capacitar os funcionários a criarem seus próprios relatórios. Como parte dessa iniciativa, treinei mais de 30 pessoas no uso do Tableau. Para dar suporte ao projeto, também padronizei o consumo de dados criando múltiplas estruturas de One Big Table, centralizando as informações para um uso mais fácil e consistente.",
            ...
            whirlpool_detalhes: "Trabalhei no departamento de trade marketing, sendo minha principal responsabilidade a criação de relatórios no Tableau. Utilizei o BigQuery para escrever consultas SQL que alimentavam esses relatórios.\nMinha entrega de maior impacto para a empresa foi um relatório de análise de precificação, que analisava o mercado comparando os preços dos produtos dos concorrentes com os da própria empresa. Esse relatório nos permitiu determinar o ponto de preço ideal para cada produto e identificar seu principal concorrente. Grandes decisões de negócios foram tomadas com base nessa análise.\nAlém disso, desenvolvi um script em Python que enviava automaticamente e-mails diários com imagens dos relatórios para a diretoria executiva da empresa.",
            anterior: "Anterior",
            proximo: "Próximo",
            ...
            cargo_nova_empresa: "Data & Web Analyst · Abr de 2025 – Presente",
            cargo_hurb: "Senior Data Analyst · Abr de 2023 - Abr de 2025 (2 anos e 1 mês)",
            cargo_frete: "Analista de dados · Jan de 2022 - Abr de 2023 (1 ano e 4 meses)",
            cargo_whirlpool: "Analista de dados júnior · Dez de 2020 - Jan de 2022 (1 ano e 2 meses)",
            ...
            conclusao: "Conclusão",
            // Traduções específicas do projeto erro qualidade
            projeto_erros_meta_qualidade: "Qualidade de dados",
            erro_intro_1: "Na minha experiência na frete.com eu trabalhei de forma muito presente no setor comercial, desde o dia que entrei eu percebi que o time tinha muita desconfiança nos dados fornecidos pelos relatórios da empresa.\nCom o passar do tempo fui entendendo que eles realmente tinham motivos para isso, sabe aquele problema de o mesmo indicador ter números diferentes dependendo do dashboard analisado? Isso acontecia com bastante frequência no tempo anterior à minha chegada na empresa.",
            erro_buscando_1: "Sabendo desses problemas de qualidade de dados na empresa, discuti soluções com meu então lider e um colega de equipe.",
            erro_buscando_2: "Sugeri criar além de uma centralização de dados numa única tabela (tabela verdade), também criar uma forma em que o próprio usuário no Tableau pudesse nos indicar (e indicar a qualquer pessoa que abrisse o relatório) que algo estava errado.",
            erro_tabela_title: "Tabela verdade?",
            erro_tabela_1: "Como disse anteriormente, a frete.com tinha muitos problemas com o mesmo indicador ter números diferentes dependendo do dashboard analisado. Isso acontecia porque em cada relatório a forma de consultar esse dado era diferente, como a empresa tinha mais de um profissional querendo a mesma informação, eles acabavam fazendo de forma diferente por falta de comunicação.",
            erro_tabela_2: "Centralizando os dados numa única tabela, o número acaba sendo exatamente o mesmo independente do dashboard analisado.\nEu tive essa ideia pensando no modelo star schema, que é basicamente centralizar os dados de dimensões numa única tabela fato.",
            erro_tabela_3: "A diferença aqui é que as dimensões são o que eu chamava de \"subqueries\", uma delas por exemplo é a query que trazia informações dos clientes, e a tabela fato era de fato a \"tabela verdade\", que juntava todas essas subqueries num único lugar.",
            erro_tabela_4: "Isso deu muito certo, conseguimos reduzir para praticamente zero os chamados relacionados a dados diferentes para o mesmo indicador nos relatórios.",
            erro_usuario_title: "Como o próprio usuário pode nos avisar que algo está errado?",
            erro_usuario_1: "Com base nas minhas experiências, já sei que apenas trabalhar com mensagens no canal oficial da empresa é algo que não funciona, principalmente por que apenas uma parte dos consumidores do relatório irão ver esse aviso no canal oficial.",
            erro_usuario_2: "Tive então que pensar numa solução funcional e criativa para isso, e cheguei na conclusão que o próprio relatório deve mostrar (em tempo real) se seus números estão corretos ou não.",
            erro_usuario_3: "E como tudo que faço, deixei a implementação de uma forma extramente intuitiva para o usuário.\nO usuário vê em tempo real a situação do relatório, ele sabe distinguir se está ruim ou bom apenas por cores.",
            erro_kpis_1: "O usuário pode ver somente um desses indicadores, e ele indica a \"saúde\" dos dados do relatório.\nA cor vermelha, como padrão em praticamente tudo, indica que algo está errado, já a cor verde que algo está bom.",
            erro_kpis_2: "Você pode ver que temos vários níveis de problemas, desde os mais simples até os mais complexos.\nO erro \"leve\" por exemplo indica geralmente que o problema é apenas em um registro, que não impacta muita coisa.\nJá o erro \"Muito grave\" indica que o problema está impactando muito os números do relatório.",
            erro_func_1: "Reforçando o compromisso com a facilidade de uso, o aviso fica visível o tempo inteiro para o usuário, sem tirar a atenção dele na análise do relatório (as cores foram pensadas para isso).",
            erro_func_2: "O usuário pode ver exatamente qual é o problema que está acontecendo simplesmente passando o mouse por cima do aviso.",
            erro_exemplo_1: "No exemplo acima, o relatório estava com erro \"leve\", além disso indico qual é o erro e quem é o responsável pela solução dele.",
            erro_exemplo_2: "Achou legal o layout do relatório? É todo criado por mim também, usando táticas de UI/UX design para facilitar o uso do usuário, esse layout virou um padrão nos relatórios da frete.com",
            erro_backend_title: "E como é o \"backend\" disso?",
            erro_backend_1: "É bem simples, quando o usuário vê um problema ele simplesmente clica no ícone e ele é redirecionado a um formulário google e preenche o problema que encontrou.",
            erro_backend_2: "A partir disso, recebemos um registro em um google sheets, este está atrelado ao dashboard e em tempo real já altera o icone no tableau para \"erro em análise\".\nEntão eu analiso e valido se é um erro de fato, e dou uma nota para o mesmo, se é leve, médio, etc.",
            erro_backend_3: "Até este momento os erros eram reportados manualmente, mas estávamos trabalhando para também automatizar outros erros mais fáceis de serem identificados, como um número muito outlier no faturamento.",
            erro_backend_4: "Infelizmente saí da empresa antes que conseguísse automatizar, mas tanto as tabelas verdade quanto o indicador de erro continuam presentes na empresa até hoje.",
            erro_conclusao_1: "Conforme foi visto, esta implementação foi um sucesso, como os reports de erro eram armazenados numa google sheets, nós até conseguíamos mensurar quantos erros os relatórios tinham e seus motivos.\nIsso acabou se tornando um relatório a parte, que indicava a \"saúde\" dos nossos relatórios, e também se tornou um PDI para os analistas de dados, algo do tipo: no próximo trimestre a soma de erros de seus relatórios não pode ser maior que 6.",
        ...
        en: {
            ...
            nova_empresa_descricao: "Brightdome is a consultancy firm in US",
            nova_empresa_detalhes: "I work on technical SEO migrations, SEO analysis, and Conversion Rate Optimization (CRO), ensuring data continuity and performance tracking during website transitions.\nI design and implement custom Google Tagging architectures using on-demand data layers to analyze user behavior before and after migrations.\nI use BigQuery and Python for data analysis and automation, and Looker Studio and Power BI to deliver actionable insights.\nI also work with Customer Data Platforms such as Segment to unify user data across sources.\nThe role involves close collaboration with global teams across Australia, New Zealand, the US, the Netherlands, Spain, and other regions.",
            // (obsolete Brightdome description text removed)
            hurb_descricao: "Hurb was a tourism company, its main products were hotel daily rates and travel packages.",
            _junk_to_delete: "integrating this information with Google BigQuery to generate insights and in-depth analyses. I work on the implementation and maintenance of clients’ e-commerce tagging, ensuring data collection accuracy through Google Tag Manager. In addition, I provide strategic SEO recommendations based on data from Google Search Console, identifying optimization opportunities that drive organic traffic and increase conversion rates. I also develop UI/UX design improvement proposals grounded in CRO (Conversion Rate Optimization) principles, focusing on enhancing user experience and maximizing conversion results.",
            hurb_descricao: "Hurb was a tourism company, its main products were hotel daily rates and travel packages.",
            hurb_detalhes: "I mainly worked in Growth and Conversion Rate Optimization (CRO), analyzing data using Python and BigQuery.\nDuring one of my analyses in Google Analytics (GA4), I identified an unmet market demand. To validate this insight, I designed and ran an A/B test using Kameleoon to understand customer response. The project achieved an ROI of over 4000%, representing 20% of total revenue for the products involved.\nIn addition, I delivered other high-value projects, including an in-depth hotel data analysis, where I built a highly intuitive presentation adopted across the company and used as the foundation for major strategic decisions.",
            hurb_fim: "The role ended due to company bankruptcy, resulting in a company-wide layoff.",
            ...
            frete_detalhes: "I worked within the commercial department, focusing on the company's strategic clients (key accounts). I used Snowflake to create SQL queries that powered the reports I built in Tableau. We had a strong focus on data quality, and I developed a way for users to monitor data quality in real time directly within the reports they were analyzing. I also standardized the visual design of all Tableau reports, applying UI/UX design principles.\nI was responsible for the company's Self-Service Analytics project, which aimed to enable employees to create their own reports. As part of this initiative, I trained 30+ people to use Tableau. To support the project, I also standardized data consumption by creating multiple One Big Table structures, centralizing the data for easier and more consistent use.",
            ...
            cargo_nova_empresa: "Data & Web Analyst · Apr 2025 – Present",
            cargo_hurb: "Senior Data Analyst · Apr 2023 - Apr 2025 (2 years and 1 month)",
            cargo_frete: "Data Analyst · Jan 2022 - Apr 2023 (1 year and 4 months)",
            ...
            // Traduções específicas do projeto erro qualidade
            projeto_erros_meta_qualidade: "Data quality",
            erro_intro_1: "In my experience at frete.com, I worked very closely with the sales department. From the day I started, I noticed that the team was very distrustful of the data provided by the company's reports.\n\nOver time, I began to realize they actually had good reason for it. You know that issue where the same indicator shows different numbers depending on which dashboard you're looking at? That happened quite frequently in the period before I joined the company.",
            erro_buscando_1: "Knowing about these data quality issues within the company, I discussed solutions with my leader at the time and a teammate.",
            erro_buscando_2: "I suggested creating not only a centralized data source in a single table (a \"single source of truth\") but also a way for Tableau users themselves to flag when something was wrong—alerting both us and anyone else viewing the report.",
            erro_tabela_title: "\"Truth table\"?",
            erro_tabela_1: "As I mentioned before, frete.com had many issues with the same indicator showing different numbers depending on the dashboard being analyzed. This happened because the method for querying that data varied in each report; since the company had multiple professionals seeking the same information, they ended up doing it differently due to a lack of communication.",
            erro_tabela_2: "By centralizing the data into a single table, the number ends up being exactly the same regardless of which dashboard is analyzed. I came up with this idea thinking of the Star Schema model, which is basically centralizing dimension data into a single fact table.",
            erro_tabela_3: "The difference here is that the dimensions are what I used to call \"subqueries\"—for example, one query would pull client information—and the fact table was essentially the \"truth table,\" which merged all those subqueries into a single place.",
            erro_tabela_4: "It worked out very well; we managed to reduce tickets related to conflicting data for the same indicator in reports to practically zero.",
            erro_usuario_title: "How can the users themselves let us know something is wrong?",
            erro_usuario_1: "Based on my experience, I already know that relying solely on messages in the company's official channel doesn't work, mainly because only a fraction of the report's consumers will actually see that notice.",
            erro_usuario_2: "I had to come up with a functional and creative solution, and I concluded that the report itself must show (in real time) whether its numbers are correct or not.",
            erro_usuario_3: "As with everything I do, I made the implementation extremely intuitive for the end user. The user sees the status of the report in real time and can distinguish whether it's \"good\" or \"bad\" simply by the colors.",
            erro_kpis_1: "The user can see only one of these indicators, and it represents the \"health\" of the report's data. Red, as is standard in almost everything, indicates that something is wrong, while green indicates that everything is good.",
            erro_kpis_2: "You can see that we have several levels of issues, ranging from the simplest to the most complex.\nA \"minor\" error, for example, usually indicates that the problem is limited to a single record, which doesn't have much of an impact. On the other hand, a \"very serious\" error indicates that the problem is significantly impacting the report's figures.",
            erro_func_1: "Reinforcing the commitment to ease of use, the alert remains visible to the user at all times without distracting them from the report analysis (the colors were specifically designed for this).",
            erro_func_2: "The user can see exactly what issue is occurring simply by hovering the mouse over the alert.",
            erro_exemplo_1: "In the example above, the report had a \"minor\" error; additionally, I indicate what the error is and who is responsible for resolving it.",
            erro_exemplo_2: "Did you like the layout of the report? It was also entirely created by me, using UI/UX design tactics to make it easier for the user, and this layout became a standard for reports at frete.com.",
            erro_backend_title: "And what does the \"backend\" look like?",
            erro_backend_1: "It's quite simple: when a user spots an issue, they simply click the icon and are redirected to a Google Form to report the problem they found.",
            erro_backend_2: "From there, a record is created in a Google Sheet, which is linked to the dashboard; in real-time, this changes the Tableau icon to \"error under review.\" Then, I analyze and validate whether it is indeed an error and assign it a severity level—minor, medium, etc.",
            erro_backend_3: "Up to that point, errors were reported manually, but we were working on automating other, easier-to-identify errors, such as extreme revenue outliers.",
            erro_backend_4: "Unfortunately, I left the company before I could implement the automation, but both the \"truth tables\" (SSoT) and the error indicators remain in use at the company to this day.",
            erro_conclusao_1: "As we have seen, this implementation was a success. Since the error reports were stored in a Google Sheet, we were even able to measure how many errors the reports had and their root causes.\nThis eventually became a separate report indicating the \"health\" of our dashboards, and it also became a performance goal for the data analysts—something like: \"In the next quarter, the total number of errors in your reports cannot exceed 6.\"",
            // Traduções específicas do projeto decoy effect
