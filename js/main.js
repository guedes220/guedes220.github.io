document.addEventListener('DOMContentLoaded', function() {
    ...
    const translations = {
        pt: {
            ...
            ajudando_empresas: "Ajudando empresas a tomarem decisões mais inteligentes e baseadas em evidências há 4 anos e 8 meses.",
            ...
            hurb_fim: "Infelizmente a empresa faliu após o dono ser preso.",
            ...
            moinho_descricao: "Se destaca pela produção de farinhas de trigo e massas alimentícias de alta qualidade.",
            moinho_detalhes: "Desenvolvia relatórios no Tableau e Power BI para diversas áreas da empresa, com foco no setor comercial. Utilizava SQL Server para consumir e realizar ETL dos dados do Protheus (TOTVS). Além disso, criava e atualizava planilhas inteligentes no Excel para apoiar a equipe de produção. No dia a dia, identificava desafios do setor comercial e implementava soluções para otimizar a tomada de decisão, incluindo a distribuição de metas dos vendedores.Minha principal entrega foi a criação de um bot no Telegram, desenvolvido em Python, que enviava automaticamente imagens de relatórios do Tableau para os vendedores, permitindo que acompanhassem seu progresso em tempo real.",
            anterior: "Anterior",
            proximo: "Próximo",
            ...
            recomendacao_jean: "Foi meu gestor direto no Moinho Arapongas",
            ...
            cargo_moinho: "Analista de business intelligence JR · Out de 2020 - Dez de 2021 (1 ano e 3 meses)",
        ...
        en: {
            ...
            ajudando_empresas: "Helping companies make smarter, evidence-based decisions for 4 years and 8 months.",
            ...
            whirlpool_detalhes: "I worked in the Trade Marketing sector, focused on creating reports in Tableau. I used BigQuery to develop SQL queries that fed these analyses. My main delivery was a price analysis report that compared the company's product values with competitors', allowing identification of the ideal price for each item and its main rival in the market. This report supported strategic decisions. Additionally, I developed a Python script that automatically sent daily emails with report images to the board.",
            moinho_descricao: "It stands out for the production of high-quality wheat flours and pasta.",
            moinho_detalhes: "I developed reports in Tableau and Power BI for various areas of the company, focusing on the commercial sector. I used SQL Server to consume and perform ETL of Protheus (TOTVS) data. Additionally, I created and updated intelligent spreadsheets in Excel to support the production team. On a daily basis, I identified challenges in the commercial sector and implemented solutions to optimize decision-making, including the distribution of sales targets. My main delivery was the creation of a Telegram bot, developed in Python, that automatically sent Tableau report images to salespeople, allowing them to track their progress in real-time.",
            anterior: "Previous",
            proximo: "Next",
            ...
            recomendacao_jean: "Was my direct manager at Moinho Arapongas",
            ...
            cargo_whirlpool: "Business Intelligence Consultant Analyst PL · Dec 2021 - Apr 2023 (1 year and 5 months)",
            cargo_moinho: "Junior Business Intelligence Analyst · Oct 2020 - Dec 2021 (1 year and 3 months)",
